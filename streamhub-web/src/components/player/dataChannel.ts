/**
 * LiveKit data-channel primitives shared by the player addons (chat +
 * reactions). Mirrors the streamhub-core convention:
 *   - topic `chat`     → reliable text messages (may carry emojis)
 *   - topic `reaction` → lossy floating reactions
 *
